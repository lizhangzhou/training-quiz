...
export default function Home() {
  ...
  return <div className="app-shell">
    <header className="topbar">
      <button className="brand" onClick={() => nav("home")}><span className="shield">⚡</span><span>2026湖南省培刷题助手</span></button>
      <nav>
...
function AuthLoading() {
  return <main className="auth-shell"><section className="auth-card auth-loading"><span className="shield">⚡</span><h1>2026湖南省培刷题助手</h1><p>正在安全连接账号服务…</p><i aria-hidden="true" /></section></main>;
}
